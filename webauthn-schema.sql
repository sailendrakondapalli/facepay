...
-- Stores public keys for device biometric authentication
-- IMPORTANT: This NEVER stores actual fingerprints or biometric data
...
-- Payment authorizations table (enhanced with WebAuthn)
...
-- WebAuthn challenges table (temporary storage for challenges)
